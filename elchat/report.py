...
def get_system_info():
    ...
    info['elchat_base_dir'] = os.environ.get('ELCHAT_BASE_DIR', 'out')
...
def generate_header():
    ...
    header = f"""# elchat training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `elchat reset`?")
...
# -----------------------------------------------------------------------------
# elchat-specific convenience functions
...
def get_report():
    ...
    from elchat.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset elchat training reports.")
